...
startButton.addEventListener('touchend', (e) => handleButtonAction(e, startGame));

restartButton.addEventListener('click', (e) => handleButtonAction(e, resetGame));
restartButton.addEventListener('touchend', (e) => handleButtonAction(e, resetGame));

menuButton.addEventListener('click', (e) => handleButtonAction(e, backToMenu));
menuButton.addEventListener('touchend', (e) => handleButtonAction(e, backToMenu));

// ... (omissis)

// Listener per il salto del personaggio (TOCCO su qualsiasi punto del contenitore di gioco - Mobile)
gameContainer.addEventListener('touchstart', (e) => {
    // ... (questo listener resta come prima)
    e.preventDefault(); 
    if (!isGameOver) {
        jump();
    }
