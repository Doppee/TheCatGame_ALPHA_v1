...
startButton.addEventListener('click', (e) => handleButtonAction(e, startGame));
restartButton.addEventListener('click', (e) => handleButtonAction(e, resetGame));
menuButton.addEventListener('click', (e) => handleButtonAction(e, backToMenu));
...
// 1. Unico Listener per il TOCCARE (touchstart) che gestisce Mobile
gameContainer.addEventListener('touchstart', handleGameInput);

// 2. Unico Listener per il CLICK (mouse) che gestisce Desktop/Browser
gameContainer.addEventListener('click', handleGameInput);


// Rimuovi i tre listener che avevi dopo 'document.addEventListener('keydown', ...)'
// e sostituiscili con i due seguenti:
