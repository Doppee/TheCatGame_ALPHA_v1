...
function handleButtonAction(e, actionFunction) {
    e.stopPropagation(); // 🛑 Blocca la propagazione al gameContainer (risolve il "saltino")
    
    // 🛑 Esegui l'azione del pulsante
    actionFunction();
}

// 🆕 NUOVI Listener per i pulsanti di Menu e Game Over con blocco della propagazione
